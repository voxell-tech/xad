...
impl ViewNode for SdfNode {
    ...
    fn run<'w>(
        ...
        let sdf_pipeline = world.resource::<PostProcessPipeline>();
        ...
        // `destination` because calling `sdf_write()` on the
        ...
        // The reason it doesn't work is because each sdf_write will alternate the source/destination.
