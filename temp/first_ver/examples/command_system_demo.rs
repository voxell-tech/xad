//! Rough proof-of-concept: build a scene through the linear command
//! system instead of hand-written `commands.spawn` calls
...
fn run_timeline(world: &mut World) {
    let mut timeline = FeatureTimeline::new();
